...
# 使用 torchsummary 显示模型结构
summary(model, (1, 64, 64))
loss_history = [loss.detach().numpy() for loss in loss_history]  # 将损失转换为NumPy数组
# accuracy_history = [accuracy_history.detach().numpy() for accuracy in accuracy_history]
